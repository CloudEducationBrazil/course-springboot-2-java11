...
import com.educandoweb.coursejava.repositories.CategoryRepository;
import com.educandoweb.coursejava.repositories.OrderItemRepository;
import com.educandoweb.coursejava.repositories.OrderRepository;
import com.educandoweb.coursejava.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// Associação muitos para muitos: produto x categoria
		...
		// Salvar os produtos com as assoiações
		productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5));
		...
		// equivalente à GMT.
		Order o1 = new Order(null, Instant.parse("2019-06-20T19:53:07Z"), OrderStatus.PAID, u1); // Padrão UTC horário GMT
